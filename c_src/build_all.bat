...
set CORE=mainline.c frame.c objects.c enemies.c score.c irq_coins.c pages.c dvg_pages.c omega_pagerom.c omega_postrom.c post.c sound_samples.c omega_shapes.c glue.c dvg.c omega_vecrom.c omega_dvgprom.c platform\headless\plat_headless.c
...
for %%P in (probe_wave probe_nvram probe_hiscore probe_sound probe_post) do (
  echo === %%P
